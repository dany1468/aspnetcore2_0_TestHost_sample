...
namespace E2eTest.Infrastracture
{
    ...
    // https://github.com/aspnet/Mvc/blob/dev/src/Microsoft.AspNetCore.Mvc.Testing/WebApplicationTestFixture.cs
    ...
    public class WebApplicationTestFixture<TStartup> : IDisposable where TStartup : class
    {
        ...
        /// <summary>
        /// Creates a <see cref="WebHostBuilder"/> used to setup <see cref="TestServer"/>.
        /// <remarks>
        ...
        /// </remarks>
        /// </summary>
        /// <returns>A <see cref="WebHostBuilder"/> instance.</returns>
        protected virtual WebHostBuilder CreateWebHostBuilder() =>
             new WebHostBuilder();

        /// <summary>
        /// Creates the <see cref="TestServer"/> with the bootstrapped application in <paramref name="builder"/>.
        /// </summary>
        /// <param name="builder">The <see cref="WebHostBuilder"/> used to
        /// create the server.</param>
        /// <returns>The <see cref="TestServer"/> with the bootstrapped application.</returns>
        protected virtual TestServer CreateServer(WebHostBuilder builder) => new TestServer(builder);

        /// <summary>
        /// Gives a fixture an opportunity to configure the application before it gets built.
        /// </summary>
        /// <param name="builder">The <see cref="WebHostBuilder"/> for the application.</param>
        protected virtual void ConfigureWebHost(WebHostBuilder builder)
        {
        }
